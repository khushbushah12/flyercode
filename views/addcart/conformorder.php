...
<center><h1 style="background-color: #008CB7;">step:4 Invoice Report</h1></center>
<h3>Your invoice Id is: <?php echo $row; ?></h3>
<form method="post" action="<?php echo url1;?>addcart/home">
	<div class="container">
	...
	<center>
		...
		<?php }?>
		<input type="submit" style="align: left; width: 200px;" class="btn btn-success" name="home" value="home" >
			<a style="align: left; width: 200px;" class="btn btn-success" href="javascript:window.print()">
